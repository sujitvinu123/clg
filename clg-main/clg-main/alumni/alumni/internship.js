...
function initInternshipListings() {
  ...
  const renderInternships = () => {
    ...
    mockInternships.forEach((job, index) => {
      ...
      card.className = `editorial-card job-card reveal stagger-${delayScale}`;
      ...
      card.innerHTML = `
        ...
        <a href="#" class="inst-btn inst-btn-outline" style="width: 100%; border-color: var(--inst-border-dark); color: var(--inst-text-main);">View Details</a>
      `;
